...
public class EmployeeManagementSystem {
    public static void main(String[] args) {
        Employee manager = new Manager("Dhruv Sharma", 001, 90000, 10);
        Employee developer = new Developer("Rohit Sharma", 102, 70000, "Java");
        Employee intern = new Intern("Naam Simran", 103, 20000, 6);
